/* ============================================================
   ...
   Description: SVG donut/pie chart with center label and hover effects
   ============================================================ */
...
export default function DonutChart({ data, size = 200, strokeWidth = 32, defaultLabel = 'Segments', defaultValue }) {
  ...
  const displayVal = defaultValue !== undefined ? defaultValue : data.length;
    ...
    <div className="kfpl-donut-wrap">
      ...
      <div className="kfpl-donut-center">
        <span className="kfpl-donut-center-value">
          {hoveredIndex !== null ? `${segments[hoveredIndex].value}%` : displayVal}
        </span>
        <span className="kfpl-donut-center-label">
          {hoveredIndex !== null ? segments[hoveredIndex].segment : defaultLabel}
        </span>
      </div>
    </div>
  );
